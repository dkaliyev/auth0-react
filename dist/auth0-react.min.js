!(function (t, e) {
  ...
  function o(t, e) {
    ...
    if (null != t && 'function' == typeof Object.getOwnPropertySymbols) {
      ...
      for (n = Object.getOwnPropertySymbols(t); c < n.length; c++)
        e.indexOf(n[c]) < 0 &&
          Object.prototype.propertyIsEnumerable.call(t, n[c]) &&
          (i[n[c]] = t[n[c]]);
    }
    return i;
  }
  ...
  var m = function (t) {
    ...
    S = p(function () {
      ...
      ? function (t) {
          return 'String' == X(t) ? x.call(t, '') : Object(t);
        }
      : Object,
    G = function (t) {
    ...
    J = function (t, e) {
      if (!v(t)) return t;
      var i, n;
      if (e && 'function' == typeof (i = t.toString) && !v((n = i.call(t))))
        return n;
    ...
    N = {
      f: C
        ...
        : function (t, e) {
            ...
            if (H(t, e)) return V(!U.f.call(t, e), t[e]);
          },
    },
    k = function (t) {
    ...
    P = h['__core-js_shared__'] || z('__core-js_shared__', {}),
    O = Function.toString;
  ...
  var dt,
    ...
    yt = B(function (t) {
      ...
      (t.exports = function (t, e, c, o) {
        var r = !!o && !!o.unsafe,
          l = !!o && !!o.enumerable,
          s = !!o && !!o.noTargetGet;
        'function' == typeof c &&
          ('string' != typeof e || H(c, 'name') || K(c, 'name', e),
          (i(c).source = n.join('string' == typeof e ? e : ''))),
          t !== h
            ? (r ? !s && t[e] && (l = !0) : delete t[e],
              l ? (t[e] = c) : K(t, e, c))
            : l
            ? (t[e] = c)
            : z(e, c);
      })(Function.prototype, 'toString', function () {
        return ('function' == typeof this && e(this).source) || _(this);
      });
    }),
    Bt = h,
    mt = function (t) {
    ...
    ht = function (t, e) {
      return arguments.length < 2
        ? mt(Bt[t]) || mt(h[t])
        : (Bt[t] && Bt[t][e]) || (h[t] && h[t][e]);
    },
    pt = Math.ceil,
    Ct = Math.floor,
    Ft = function (t) {
      return isNaN((t = +t)) ? 0 : (t > 0 ? Ct : pt)(t);
    },
    ft = Math.min,
    Ut = function (t) {
      return t > 0 ? ft(Ft(t), 9007199254740991) : 0;
    },
    Vt = Math.max,
    Zt = Math.min,
    Xt = function (t) {
      return function (e, i, n) {
        var c,
          ...
          l = (function (t, e) {
            var i = Ft(t);
            return i < 0 ? Vt(i + e, 0) : Zt(i, e);
          })(n, r);
        if (t && i != i) {
          for (; r > l; ) if ((c = o[l++]) != c) return !0;
        } else
          for (; r > l; l++)
            if ((t || l in o) && o[l] === i) return t || l || 0;
        return !t && -1;
      };
    },
    xt = { includes: Xt(!0), indexOf: Xt(!1) },
    St = xt.indexOf,
    Gt = function (t, e) {
      var i,
        n = Q(t),
        c = 0,
        o = [];
      for (i in n) !H(rt, i) && H(n, i) && o.push(i);
      for (; e.length > c; ) H(n, (i = e[c++])) && (~St(o, i) || o.push(i));
      return o;
    },
    Qt = [
      'constructor',
    ...
    At = function (t, e) {
      for (var i = Ht(e), n = T.f, c = N.f, o = 0; o < i.length; o++) {
        var r = i[o];
        H(t, r) || n(t, r, c(e, r));
      }
    },
    ...
    Lt = function (t, e) {
      var i = Yt[wt(t)];
      return i == kt || (i != Nt && ('function' == typeof e ? p(e) : !!e));
    },
    wt = (Lt.normalize = function (t) {
    ...
    Kt = function (t, e) {
      var i,
        ...
        s = t.global,
        u = t.stat;
      if ((i = s ? h : u ? h[l] || z(l, {}) : (h[l] || {}).prototype))
        for (n in e) {
          if (
            ((o = e[n]),
            (c = t.noTargetGet ? (r = Tt(i, n)) && r.value : i[n]),
            !Et(s ? n : l + (u ? '.' : '#') + n, t.forced) && void 0 !== c)
          ) {
            if (typeof o == typeof c) continue;
            At(o, c);
          }
          (t.sham || (c && c.sham)) && K(o, 'sham', !0), yt(i, n, o, t);
        }
    },
    zt =
    ...
    Pt = zt && !Symbol.sham && 'symbol' == typeof Symbol.iterator,
    Ot = tt('wks'),
    jt = h.Symbol,
    Dt = Pt ? jt : (jt && jt.withoutSetter) || nt,
    Mt = function (t) {
      return (
        H(Ot, t) ||
          (zt && H(jt, t) ? (Ot[t] = jt[t]) : (Ot[t] = Dt('Symbol.' + t))),
        Ot[t]
      );
    },
    _t = Mt('match'),
    qt = function (t) {
      if (
        (function (t) {
          var e;
          return v(t) && (void 0 !== (e = t[_t]) ? !!e : 'RegExp' == X(t));
        })(t)
      )
    ...
    ce = te('startsWith'),
    oe = !(
      ce || ((dt = ee(String.prototype, 'startsWith')), !dt || dt.writable)
    );
  Kt(
    { target: 'String', proto: !0, forced: !oe && !ce },
    {
      startsWith: function (t) {
        var e = String(G(this));
        qt(t);
        var i = Ut(ne(arguments.length > 1 ? arguments[1] : void 0, e.length)),
          n = String(t);
        return ie ? ie.call(e, n, i) : e.slice(i, i + n.length) === n;
      },
    }
  );
  var re,
    ...
    ae = Function.call,
    Ie = function (t, e, i) {
      return ue(ae, h[t].prototype[e], i);
    },
    ge =
    ...
    Be = function (t, e) {
      ...
      return (
        ge(t) &&
          ...
          (i !== Array && !ge(i.prototype))
            ? v(i) && null === (i = i[ye]) && (i = void 0)
            : (i = void 0)),
        new (void 0 === i ? Array : i)(0 === e ? 0 : e)
      );
    },
    me = ht('navigator', 'userAgent') || '',
    he = h.process,
    pe = he && he.versions,
    Ce = pe && pe.v8;
  Ce
    ? (le = (re = Ce.split('.'))[0] + re[1])
    : me &&
      (!(re = me.match(/Edge\/(\d+)/)) || re[1] >= 74) &&
      (re = me.match(/Chrome\/(\d+)/)) &&
      (le = re[1]);
  var Fe = le && +le,
    fe = Mt('species'),
    Ue = Mt('isConcatSpreadable'),
    Ve =
      Fe >= 51 ||
      !p(function () {
        var t = [];
        return (t[Ue] = !1), t.concat()[0] !== t;
      }),
    Ze =
      Fe >= 51 ||
      !p(function () {
    ...
    Xe = function (t) {
      if (!v(t)) return !1;
      var e = t[Ue];
      return void 0 !== e ? !!e : ge(t);
    };
  Kt(
    { target: 'Array', proto: !0, forced: !Ve || !Ze },
    {
      concat: function (t) {
        var e,
          i,
        ...
        for (e = -1, n = arguments.length; e < n; e++)
          if (Xe((o = -1 === e ? r : arguments[e]))) {
            if (s + (c = Ut(o.length)) > 9007199254740991)
              throw TypeError('Maximum allowed index exceeded');
            for (i = 0; i < c; i++, s++) i in o && be(l, s, o[i]);
          } else {
  ...
  Se || yt(Object.prototype, 'toString', Je, { unsafe: !0 });
  var Re,
    He =
      Object.keys ||
      function (t) {
    ...
    Ae = C
      ...
      : function (t, e) {
          k(t);
          for (var i, n = He(e), c = n.length, o = 0; c > o; )
            T.f(t, (i = n[o++]), e[i]);
          return t;
        },
    We = ht('document', 'documentElement'),
    Le = ot('IE_PROTO'),
    we = function () {},
    Ye = function (t) {
    ...
    Ne = function () {
      try {
        Re = document.domain && new ActiveXObject('htmlfile');
      } catch (t) {}
      var t, e;
      Ne = Re
        ? (function (t) {
        ...
        : (((e = L('iframe')).style.display = 'none'),
          ...
          t.write(Ye('document.F=Object')),
          t.close(),
          t.F);
      for (var i = Qt.length; i--; ) delete Ne.prototype[Qt[i]];
      return Ne();
    };
  rt[Le] = !0;
  var ke =
    ...
    ze = {
      f: function (t) {
        return Ke && '[object Window]' == Te.call(t)
          ? (function (t) {
              try {
                return Ee(t);
              } catch (t) {
    ...
    Oe = T.f,
    je = function (t) {
      var e = Bt.Symbol || (Bt.Symbol = {});
      H(e, t) || Oe(e, t, { value: Pe.f(t) });
    },
    De = T.f,
    Me = Mt('toStringTag'),
    _e = function (t, e, i) {
      t &&
        !H((t = i ? t : t.prototype), Me) &&
        De(t, Me, { configurable: !0, value: e });
    },
    qe = [].push,
    $e = function (t) {
      var e = 1 == t,
      ...
      return function (l, s, u, a) {
        for (
          var I,
            ...
            m = 0,
            h = a || Be,
            p = e ? h(l, B) : i ? h(l, 0) : void 0;
          B > m;
          m++
        )
          if ((r || m in b) && ((g = y((I = b[m]), m, d)), t))
            if (e) p[m] = g;
            else if (g)
              switch (t) {
                case 3:
    ...
    ti = [$e(0), $e(1), $e(2), $e(3), $e(4), $e(5), $e(6)][0],
    ei = ot('hidden'),
    ii = Mt('toPrimitive'),
    ni = bt.set,
    ci = bt.getterFor('Symbol'),
    oi = Object.prototype,
    ri = h.Symbol,
    li = ht('JSON', 'stringify'),
    si = N.f,
    ui = T.f,
    ai = ze.f,
    Ii = U.f,
    gi = tt('symbols'),
    di = tt('op-symbols'),
    bi = tt('string-to-symbol-registry'),
    yi = tt('symbol-to-string-registry'),
    Bi = tt('wks'),
    mi = h.QObject,
    hi = !mi || !mi.prototype || !mi.prototype.findChild,
    pi =
      C &&
      p(function () {
        return (
        ...
        ? function (t, e, i) {
            var n = si(oi, e);
            n && delete oi[e], ui(t, e, i), n && t !== oi && ui(oi, e, n);
          }
        : ui,
    Ci = function (t, e) {
      var i = (gi[t] = ke(ri.prototype));
      return (
        ni(i, { type: 'Symbol', tag: t, description: e }),
        C || (i.description = e),
        i
      );
    },
    Fi = Pt
      ...
      return (
        ...
        H(gi, n)
          ? (i.enumerable
              ? (H(t, ei) && t[ei][n] && (t[ei][n] = !1),
                (i = ke(i, { enumerable: V(0, !1) })))
              : (H(t, ei) || ui(t, ei, V(1, {})), (t[ei][n] = !0)),
            pi(t, n, i))
          : ui(t, n, i)
      );
    },
    ...
    Vi = function (t) {
      var e = J(t, !0),
        i = Ii.call(this, e);
      return (
        !(this === oi && H(gi, e) && !H(di, e)) &&
        (!(i || !H(this, e) || !H(gi, e) || (H(this, ei) && this[ei][e])) || i)
      );
    },
    Zi = function (t, e) {
      var i = Q(t),
        n = J(e, !0);
      if (i !== oi || !H(gi, n) || H(di, n)) {
        var c = si(i, n);
        return (
          !c || !H(gi, n) || (H(i, ei) && i[ei][n]) || (c.enumerable = !0), c
        );
      }
    },
    Xi = function (t) {
  ...
  if (
    (zt ||
      (yt(
        (ri = function () {
          ...
          var t =
            ...
            i = function (t) {
              this === oi && i.call(di, t),
                H(this, ei) && H(this[ei], e) && (this[ei][e] = !1),
                pi(this, e, V(1, t));
            };
          return C && hi && pi(oi, e, { configurable: !0, set: i }), Ci(e, t);
        }).prototype,
        'toString',
        function () {
          return ci(this).tag;
      ...
      yt(ri, 'withoutSetter', function (t) {
        return Ci(nt(t), t);
      }),
      (U.f = Vi),
      (T.f = fi),
      ...
      C &&
        (ui(ri.prototype, 'description', {
          configurable: !0,
          get: function () {
            return ci(this).description;
          },
        }),
        yt(oi, 'propertyIsEnumerable', Vi, { unsafe: !0 }))),
    Kt({ global: !0, wrap: !0, forced: !zt, sham: !zt }, { Symbol: ri }),
    ti(He(Bi), function (t) {
      je(t);
    }),
    Kt(
      { target: 'Symbol', stat: !0, forced: !zt },
      {
        for: function (t) {
          var e = String(t);
          if (H(bi, e)) return bi[e];
          var i = ri(e);
          return (bi[e] = i), (yi[i] = e), i;
        },
        keyFor: function (t) {
          if (!Fi(t)) throw TypeError(t + ' is not a symbol');
          if (H(yi, t)) return yi[t];
        },
        useSetter: function () {
          hi = !0;
        },
    ...
    Kt(
      { target: 'Object', stat: !0, forced: !zt, sham: !C },
      {
        create: function (t, e) {
          return void 0 === e ? ke(t) : Ui(ke(t), e);
        },
        defineProperty: fi,
        defineProperties: Ui,
    ...
    Kt(
      { target: 'Object', stat: !0, forced: !zt },
      { getOwnPropertyNames: Xi, getOwnPropertySymbols: xi }
    ),
    Kt(
      {
        target: 'Object',
    ...
    var Si =
      ...
      p(function () {
        var t = ri();
        return (
          '[null]' != li([t]) || '{}' != li({ a: t }) || '{}' != li(Object(t))
        );
      });
    Kt(
      { target: 'JSON', stat: !0, forced: Si },
      {
        stringify: function (t, e, i) {
          for (var n, c = [t], o = 1; arguments.length > o; )
            c.push(arguments[o++]);
          if (((n = e), (v(e) || void 0 !== t) && !Fi(t)))
            return (
              ge(e) ||
                (e = function (t, e) {
                  if (
                    ('function' == typeof n && (e = n.call(this, t, e)), !Fi(e))
                  )
                    return e;
                }),
              (c[1] = e),
  ...
  ri.prototype[ii] || K(ri.prototype, ii, ri.prototype.valueOf),
    _e(ri, 'Symbol'),
    (rt[ei] = !0),
    je('asyncIterator');
  var Gi = T.f,
  ...
  if (
    C &&
    'function' == typeof Qi &&
    (!('description' in Qi.prototype) || void 0 !== Qi().description)
  ) {
    var vi = {},
      Ji = function () {
        var t =
            arguments.length < 1 || void 0 === arguments[0]
              ? void 0
              : String(arguments[0]),
          e = this instanceof Ji ? new Qi(t) : void 0 === t ? Qi() : Qi(t);
        return '' === t && (vi[e] = !0), e;
      };
    At(Ji, Qi);
    var Ri = (Ji.prototype = Qi.prototype);
    Ri.constructor = Ji;
    var Hi = Ri.toString,
      Ai = 'Symbol(test)' == String(Qi('test')),
      Wi = /^Symbol\((.*)\)[^)]+$/;
    Gi(Ri, 'description', {
      configurable: !0,
      get: function () {
        var t = v(this) ? this.valueOf() : this,
          e = Hi.call(t);
        if (H(vi, t)) return '';
        var i = Ai ? e.slice(7, -1) : e.replace(Wi, '$1');
        return '' === i ? void 0 : i;
      },
    }),
      Kt({ global: !0, forced: !0 }, { Symbol: Ji });
  }
  je('hasInstance'),
    je('isConcatSpreadable'),
    je('iterator'),
    je('match'),
    je('matchAll'),
    je('replace'),
  ...
  [].keys &&
    ('next' in (Yi = [].keys())
      ? (wi = zi(zi(Yi))) !== Object.prototype && (Li = wi)
      : (Oi = !0)),
    null == Li && (Li = {}),
    H(Li, Pi) ||
      K(Li, Pi, function () {
  ...
  var ji = { IteratorPrototype: Li, BUGGY_SAFARI_ITERATORS: Oi },
    Di = {},
    Mi = ji.IteratorPrototype,
    _i = function () {
      return this;
    },
    qi =
      ...
      ('__proto__' in {}
        ...
        : void 0),
    $i = ji.IteratorPrototype,
    tn = ji.BUGGY_SAFARI_ITERATORS,
    en = Mt('iterator'),
    nn = function () {
      return this;
    },
    cn = function (t, e, i, n, c, o, r) {
      !(function (t, e, i) {
        var n = e + ' Iterator';
        (t.prototype = ke(Mi, { next: V(1, i) })), _e(t, n, !1), (Di[n] = _i);
      })(i, e, n);
      var l,
        s,
        u,
        ...
        g = !1,
        d = t.prototype,
        b = d[en] || d['@@iterator'] || (c && d[c]),
        y = (!tn && b) || a(c),
        B = ('Array' == e && d.entries) || b;
      if (
        (B &&
          ((l = zi(B.call(new t()))),
          $i !== Object.prototype &&
            l.next &&
            (zi(l) !== $i &&
              (qi ? qi(l, $i) : 'function' != typeof l[en] && K(l, en, nn)),
            _e(l, I, !0))),
        'values' == c &&
          b &&
          'values' !== b.name &&
        ...
        if (
          ...
          for (u in s) (tn || g || !(u in d)) && yt(d, u, s[u]);
        else Kt({ target: e, proto: !0, forced: tn || g }, s);
      return s;
    },
    on = ki.charAt,
    rn = bt.set,
    ln = bt.getterFor('String Iterator');
  cn(
    String,
    'String',
    function (t) {
      rn(this, { type: 'String Iterator', string: String(t), index: 0 });
    },
    function () {
      var t,
        e = ln(this),
      ...
      return n >= i.length
        ? { value: void 0, done: !0 }
        : ((t = on(i, n)), (e.index += t.length), { value: t, done: !1 });
    }
  );
  var sn = function (t, e, i, n) {
      try {
        return n ? e(k(i)[0], i[1]) : e(i);
      } catch (e) {
        var c = t.return;
        throw (void 0 !== c && k(c.call(t)), e);
      }
    },
    un = Mt('iterator'),
    an = Array.prototype,
    In = function (t) {
      return void 0 !== t && (Di.Array === t || an[un] === t);
    },
    gn = Mt('iterator'),
    dn = function (t) {
      if (null != t) return t[gn] || t['@@iterator'] || Di[ve(t)];
    },
    bn = Mt('iterator'),
    yn = !1;
  try {
  ...
  Kt(
    { target: 'Array', stat: !0, forced: pn },
    {
      from: function (t) {
        var e,
          ...
          d = 0;
        if (
          (I && (a = ue(a, u > 2 ? arguments[2] : void 0, 2)),
          null == g || (s == Array && In(g)))
        )
          for (i = new s((e = Ut(l.length))); e > d; d++)
            (r = I ? a(l[d], d) : l[d]), be(i, d, r);
        else
          for (
            o = (c = g.call(l)).next, i = new s();
            !(n = o.call(c)).done;
            d++
          )
            (r = I ? sn(c, a, [n.value, d], !0) : n.value), be(i, d, r);
        return (i.length = d), i;
      },
    }
  ),
    Bt.Array.from;
  var Cn,
    Fn = 'undefined' != typeof ArrayBuffer && 'undefined' != typeof DataView,
    fn = T.f,
    Un = h.Int8Array,
    Vn = Un && Un.prototype,
    Zn = h.Uint8ClampedArray,
    Xn = Zn && Zn.prototype,
    xn = Un && zi(Un),
    Sn = Vn && zi(Vn),
    Gn = Object.prototype,
    Qn = Gn.isPrototypeOf,
    vn = Mt('toStringTag'),
    Jn = nt('TYPED_ARRAY_TAG'),
    Rn = Fn && !!qi && 'Opera' !== ve(h.opera),
    Hn = {
      Int8Array: 1,
      Uint8Array: 1,
      Uint8ClampedArray: 1,
  ...
  for (Cn in Hn) h[Cn] || (Rn = !1);
  if (
    (!Rn || 'function' != typeof xn || xn === Function.prototype) &&
    ((xn = function () {
      throw TypeError('Incorrect invocation');
    }),
    Rn)
  )
    for (Cn in Hn) h[Cn] && qi(h[Cn], xn);
  if ((!Rn || !Sn || Sn === Gn) && ((Sn = xn.prototype), Rn))
    for (Cn in Hn) h[Cn] && qi(h[Cn].prototype, Sn);
  if ((Rn && zi(Xn) !== Sn && qi(Xn, Sn), C && !H(Sn, vn)))
    for (Cn in (fn(Sn, vn, {
      get: function () {
        return v(this) ? this[Jn] : void 0;
      },
    }),
    Hn))
      h[Cn] && K(h[Cn], Jn, Cn);
  var An = Mt('species'),
    ...
    Ln = function (t) {
      if (qi) {
        if (Qn.call(xn, t)) return t;
      } else
        for (var e in Hn)
          if (H(Hn, Cn)) {
            var i = h[e];
            if (i && (t === i || Qn.call(i, t))) return t;
          }
  ...
  !(function (t, e, i) {
    if (C) {
      if (i)
        for (var n in Hn) {
          var c = h[n];
          c && H(c.prototype, t) && delete c.prototype[t];
        }
      (Sn[t] && !i) || yt(Sn, t, i ? e : (Rn && Vn[t]) || e);
    }
  })(
    'slice',
    function (t, e) {
      for (
        var i = wn.call(Wn(this), t, e),
          n = (function (t, e) {
            var i,
              n = k(t).constructor;
            return void 0 === n || null == (i = k(n)[An]) ? e : se(i);
  ...
  var Yn = Mt('unscopables'),
    Nn = Array.prototype;
  null == Nn[Yn] && T.f(Nn, Yn, { configurable: !0, value: ke(null) });
  var kn = function (t) {
      Nn[Yn][t] = !0;
    },
    ...
    Pn = (function (t, e) {
      ...
      return (Tn[t] =
        ...
        !p(function () {
          if (n && !C) return !0;
          var t = { length: -1 };
          n ? En(t, 1, { enumerable: !0, get: Kn }) : (t[1] = 1),
            i.call(t, c, o);
        }));
  ...
  Kt(
    ...
    Ie('Array', 'includes'),
    Kt(
      { target: 'String', proto: !0, forced: !te('includes') },
      {
        includes: function (t) {
  ...
  var On = !p(function () {
    ...
    jn = B(function (t) {
      var e = T.f,
        ...
        r = (t.exports = {
          ...
          onFreeze: function (t) {
            return On && r.REQUIRED && c(t) && !H(t, i) && o(t), t;
          },
        });
      rt[i] = !0;
    }),
      ...
      B(function (t) {
        ...
        (t.exports = function (t, i, n, c, o) {
          ...
          if (o) r = t;
            ...
            if ('function' != typeof (l = dn(t)))
              throw TypeError('Target is not iterable');
            if (In(l)) {
              for (s = 0, u = Ut(t.length); u > s; s++)
                if (
                  (a = c ? d(k((g = t[s]))[0], g[1]) : d(t[s])) &&
                  a instanceof e
                )
                  return a;
              return new e(!1);
          ...
          for (I = r.next; !(g = I.call(r)).done; )
            if (
              'object' == typeof (a = sn(r, d, g.value, c)) &&
              a &&
              a instanceof e
            )
              return a;
    ...
    nc =
      ((function (t, e, i) {
          ...
          a = function (t) {
            ...
            yt(
              ...
              'add' == t
                ...
                : 'delete' == t
                ? function (t) {
                    return !(c && !v(t)) && e.call(this, 0 === t ? 0 : t);
                  }
                : 'get' == t
                ? function (t) {
                    return c && !v(t) ? void 0 : e.call(this, 0 === t ? 0 : t);
                  }
                : 'has' == t
                ? function (t) {
                    return !(c && !v(t)) && e.call(this, 0 === t ? 0 : t);
        ...
        if (
          ...
          (s = i.getConstructor(e, t, n, o)), (jn.REQUIRED = !0);
        else if (Et(t, !0)) {
          var I = new s(),
            g = I[o](c ? {} : -0, 1) != I,
            d = p(function () {
          ...
          b ||
            (((s = e(function (e, i) {
              ...
              return null != i && Dn(i, c[o], c, n), c;
            })).prototype = l),
            (l.constructor = s)),
            (d || y) && (a('delete'), a('has'), n && a('get')),
            (y || g) && a(o),
            c && l.clear && delete l.clear;
        }
        (u.Set = s),
          Kt({ global: !0, forced: s != r }, u),
          _e(s, t),
          c || i.setStrong(s, t, n);
      })(
        'Set',
        ...
        },
        {
          getConstructor: function (t, e, i, n) {
            ...
            return (
              _n(c.prototype, {
                clear: function () {
                  for (var t = o(this), e = t.index, i = t.first; i; )
                    (i.removed = !0),
          ...
          setStrong: function (t, e, i) {
            ...
            cn(
              ...
              function () {
                for (var t = o(this), e = t.kind, i = t.last; i && i.removed; )
                  i = i.previous;
    ...
    cc = bt.set,
    oc = bt.getterFor('Array Iterator'),
    rc = cn(
      Array,
      'Array',
      function (t, e) {
        cc(this, { type: 'Array Iterator', target: Q(t), index: 0, kind: e });
      },
      function () {
        var t = oc(this),
          e = t.target,
  ...
  (Di.Arguments = Di.Array), kn('keys'), kn('values'), kn('entries');
  var lc = Mt('iterator'),
    sc = Mt('toStringTag'),
    uc = rc.values;
  for (var ac in nc) {
        ...
        hc._immediateFn(function () {
          ...
          if (null !== i) {
            ...
            try {
              ...
              return void Fc(e.promise, t);
            }
            Cc(e.promise, n);
          } else (1 === t._state ? Cc : Fc)(e.promise, t._value);
        }))
      : t._deferreds.push(e);
  }
  function Cc(t, e) {
    try {
      ...
      if (e && ('object' == typeof e || 'function' == typeof e)) {
        var i = e.then;
        if (e instanceof hc) return (t._state = 3), (t._value = e), void fc(t);
  ...
  function Fc(t, e) {
    (t._state = 2), (t._value = e), fc(t);
  }
  function fc(t) {
    2 === t._state &&
      0 === t._deferreds.length &&
      hc._immediateFn(function () {
        t._handled || hc._unhandledRejectionFn(t._value);
      });
    for (var e = 0, i = t._deferreds.length; e < i; e++) pc(t, t._deferreds[e]);
    t._deferreds = null;
  }
  function Uc(t, e, i) {
  ...
  (hc.prototype.catch = function (t) {
    return this.then(null, t);
  }),
    (hc.prototype.then = function (t, e) {
      var i = new this.constructor(mc);
      return pc(this, new Uc(t, e, i)), i;
    }),
    (hc.prototype.finally = bc),
    (hc.all = function (t) {
      return new hc(function (e, i) {
        if (!Bc(t)) return i(new TypeError('Promise.all accepts an array'));
    ...
    (hc.resolve = function (t) {
      return t && 'object' == typeof t && t.constructor === hc
        ? t
        : new hc(function (e) {
            e(t);
          });
    }),
    (hc.reject = function (t) {
      return new hc(function (e, i) {
        i(t);
      });
    }),
    (hc.race = function (t) {
      return new hc(function (e, i) {
        if (!Bc(t)) return i(new TypeError('Promise.race accepts an array'));
        for (var n = 0, c = t.length; n < c; n++) hc.resolve(t[n]).then(e, i);
      });
    }),
    (hc._immediateFn =
    ...
    (hc._unhandledRejectionFn = function (t) {
  ...
  'Promise' in Zc
    ? Zc.Promise.prototype.finally || (Zc.Promise.prototype.finally = bc)
    : (Zc.Promise = hc),
    (function (t) {
      function e() {}
      function i(t, e) {
      ...
      var a = (function () {
              ...
              },
              {
                ...
                value: function (t, e) {
                  if (t in this.listeners)
                    for (
                      var i = this.listeners[t], n = 0, c = i.length;
                      n < c;
                      n++
                    )
                      if (i[n] === e) return void i.splice(n, 1);
                },
              },
              {
                key: 'dispatchEvent',
        ...
        I = (function (e) {
          ...
          function s() {
            ...
            return (
              t(this, s),
              (e = r.call(this)).listeners || a.call(o(e)),
              Object.defineProperty(o(e), 'aborted', {
                value: !1,
                writable: !0,
                configurable: !0,
              }),
              Object.defineProperty(o(e), 'onabort', {
                value: null,
                writable: !0,
                configurable: !0,
              }),
              ...
              },
              {
                ...
                value: function (t) {
                  'abort' === t.type &&
                    ...
                    u(c(s.prototype), 'dispatchEvent', this).call(this, t);
                },
              },
            ]),
            s
          ...
          (function (t) {
            return t.__FORCE_INSTALL_ABORTCONTROLLER_POLYFILL
              ...
              : ('function' == typeof t.Request &&
                  ...
                  !t.AbortController;
          })(t) && ((t.AbortController = g), (t.AbortSignal = I));
        })('undefined' != typeof self ? self : b);
    })();
  var Xc = B(function (t, e) {
    Object.defineProperty(e, '__esModule', { value: !0 });
    var i = (function () {
      function t() {
        var t = this;
        (this.locked = new Map()),
          (this.addToLocked = function (e, i) {
            var n = t.locked.get(e);
            void 0 === n
              ? void 0 === i
                ? t.locked.set(e, [])
                : t.locked.set(e, [i])
              : void 0 !== i && (n.unshift(i), t.locked.set(e, n));
          }),
          ...
          (this.lock = function (e) {
            return new Promise(function (i, n) {
              t.isLocked(e) ? t.addToLocked(e, i) : (t.addToLocked(e), i());
            });
          }),
          (this.unlock = function (e) {
            ...
            if (void 0 !== i && 0 !== i.length) {
              var n = i.pop();
              t.locked.set(e, i), void 0 !== n && setTimeout(n, 0);
  ...
  var xc = y(
      B(function (t, e) {
        ...
        var l = (function () {
          ...
          return (
            (t.prototype.acquireLock = function (e, l) {
              return (
                void 0 === l && (l = 5e3),
                              ...
                              return (
                                ...
                                this.acquiredIatSet.has(e)
                                  ? ((i = window.localStorage),
                                    null === (c = i.getItem(t))
                                      ? (Xc.default().unlock(e), [2])
                                      : (((c = JSON.parse(
                                          c
                                        )).timeRefreshed = Date.now()),
                                        i.setItem(t, JSON.stringify(c)),
                                        Xc.default().unlock(e),
                        ...
                        new Promise(function (i) {
                          ...
                          function r() {
                            if (
                              ...
                              n = !0;
                              var e = 50 - (Date.now() - c);
                              e > 0 ? setTimeout(i, e) : i();
                            }
                          }
                          window.addEventListener('storage', r),
                            t.addToWaiting(r);
                          var l = setTimeout(r, Math.max(0, e - Date.now()));
                        }),
                      ];
                    case 1:
                      return i.sent(), [2];
                    ...
                    case 0:
                      return (
                        ...
                        null === (r = i.getItem(o))
                          ...
                          ? [3, 2]
                          : [4, Xc.default().lock(r.iat)]
                      );
                    case 1:
                      n.sent(),
                        this.acquiredIatSet.delete(r.iat),
                        i.removeItem(o),
                        Xc.default().unlock(r.iat),
                        t.notifyWaiters(),
                        (n.label = 2);
                    case 2:
                      return [2];
                ...
                if (l.includes(c)) {
                  ...
                  null !== s &&
                    ((void 0 === (s = JSON.parse(s)).timeRefreshed &&
                      s.timeAcquired < e) ||
                      (void 0 !== s.timeRefreshed && s.timeRefreshed < e)) &&
                    (i.removeItem(l), (o = !0));
                }
              }
              o && t.notifyWaiters();
    ...
    Jc = (function (t) {
      function e() {
        var i = t.call(this, 'timeout', 'Timeout') || this;
    ...
    Rc = (function (t) {
      function e(i) {
        ...
        return (n.popup = i), Object.setPrototypeOf(n, e.prototype), n;
      }
      return u(e, t), e;
    })(Jc),
    Hc = function (t, e, i) {
            ...
            if (
              ...
              i && i.close(),
                t.data.response.error
                  ? c(Qc.fromPayload(t.data.response))
                  : n(t.data.response),
                clearTimeout(s),
                window.removeEventListener('message', r, !1),
                setTimeout(l, 2e3);
      ...
      return new Promise(function (t, i) {
        var n,
          c = setTimeout(function () {
            i(new Rc(o)), window.removeEventListener('message', n, !1);
        ...
        (n = function (e) {
          if (e.data && 'authorization_response' === e.data.type) {
            if (
              ...
              return i(Qc.fromPayload(e.data.response));
            t(e.data.response);
          }
        }),
    ...
    wc = function () {
      var t =
        ...
        e = '';
      return (
        Array.from(Wc().getRandomValues(new Uint8Array(43))).forEach(function (
          i
        ) {
          return (e += t[i % t.length]);
        }),
        e
      );
    },
            ...
            case 0:
              return o
                ? (delete n.signal,
                  [
                    2,
                    ((g = a({ url: t, audience: e, scope: i, timeout: c }, n)),
                    (d = o),
                    new Promise(function (t, e) {
                      var i = new MessageChannel();
                      (i.port1.onmessage = function (i) {
                        i.data.error ? e(new Error(i.data.error)) : t(i.data);
                      }),
                        d.postMessage(g, [i.port2]);
                    })),
                  ])
                : [3, 1];
            case 1:
      ...
      return Promise.race([
        ...
        new Promise(function (t, e) {
          r = setTimeout(function () {
            l.abort(), e(new Error("Timeout when executing 'fetch'"));
          }, o);
        }),
      ]).finally(function () {
        clearTimeout(r);
    ...
    Pc = function (t, e, i, n, c, o) {
      return g(void 0, void 0, void 0, function () {
        var r, l, s, u, a, g, b, y, B, m;
        return d(this, function (d) {
          switch (d.label) {
            case 0:
              (r = null), (s = 0), (d.label = 1);
            case 1:
              if (!(s < 3)) return [3, 6];
              d.label = 2;
            case 2:
              return d.trys.push([2, 4, , 5]), [4, zc(t, i, n, c, o, e)];
            case 3:
              return (l = d.sent()), (r = null), [3, 6];
            case 4:
              return (u = d.sent()), (r = u), [3, 5];
            case 5:
              return s++, [3, 1];
            case 6:
              ...
              if (
                ...
                (y = I(a, ['error', 'error_description'])),
                !l.ok)
              )
                throw (
                  ((B = b || 'HTTP error. Unable to fetch ' + t),
                  ((m = new Error(B)).error = g || 'request_error'),
                  (m.error_description = B),
                  m)
                );
              return [2, y];
          }
    ...
    Oc = function (t, e) {
      return g(void 0, void 0, void 0, function () {
        var i,
          ...
          r = t.audience,
          l = t.scope,
          s = I(t, ['clientHash', 'baseUrl', 'timeout', 'audience', 'scope']);
        return d(this, function (t) {
          switch (t.label) {
            case 0:
              return (
                (i = new URLSearchParams(
                  a({ redirect_uri: window.location.origin }, s)
                )),
                [
                  4,
                  Pc(
    ...
    Dc = function () {
      ...
      return jc(t.join(' ').trim().split(/\s+/)).join(' ');
    },
    Mc = function (t) {
      return (
    ...
    qc = (function () {
      ...
      return (
        ...
        (t.prototype.get = function (t, e) {
          ...
          if (n) {
            if (!(n.expiresAt - e < c)) return n.body;
    ...
    no = B(function (t, e) {
      ...
      function o(t) {
        for (
          var e = {}, i = t ? t.split('; ') : [], n = /(%[\dA-F]{2})+/gi, c = 0;
          c < i.length;
          c++
        ) {
          var o = i[c].split('='),
          ...
          try {
            e[o[0].replace(n, decodeURIComponent)] = r.replace(
              n,
              decodeURIComponent
            );
          } catch (t) {}
      ...
      function l(t, e, n) {
        document.cookie = c(t, e, i({ path: '/' }, n));
      }
      (e.__esModule = !0),
        (e.encode = c),
        (e.parse = o),
  ...
  y(no), no.encode, no.parse, no.getAll;
  var co = no.get,
    oo = no.set,
    ro = no.remove,
    lo = {
    ...
    so = {
      get: function (t) {
        return lo.get(t) || lo.get('_legacy_' + t);
      },
      save: function (t, e, i) {
        var n = {};
        'https:' === window.location.protocol && (n = { secure: !0 }),
          (n.expires = i.daysUntilExpire),
          oo('_legacy_' + t, JSON.stringify(e), n),
          lo.save(t, e, i);
      },
      remove: function (t) {
        lo.remove(t), lo.remove('_legacy_' + t);
      },
    },
    uo = {
      get: function (t) {
  ...
  var ao,
    ...
    Bo = (function () {
      function t(t) {
        ...
        if (
          ...
          (this.cookieStorage = !1 === t.legacySameSiteCookie ? lo : so),
        ...
        var n,
          c,
          o = t.useCookiesForTransactions ? this.cookieStorage : uo;
        (this.cache = yo(this.cacheLocation)()),
          (this.scope = this.options.scope),
          (this.clientHash = this.options.clientHash),
          (this.transactionManager = new to(o)),
          ...
          this.options.useRefreshTokens &&
            (this.scope = Dc(this.scope, 'offline_access')),
          'undefined' != typeof window &&
            window.Worker &&
            this.options.useRefreshTokens &&
      ...
      return (
        ...
        (t.prototype._getParams = function (t, e, i, n, c) {
          var o = this.options,
            r =
              (o.domain,
              o.leeway,
          ...
          return a(a(a({}, r), t), {
            scope: Dc(this.defaultScope, this.scope, t.scope),
            response_type: 'code',
            response_mode: 'query',
            state: e,
            nonce: i,
        ...
        (t.prototype._authorizeUrl = function (t) {
          return this._url('/authorize?' + Nc(t));
        }),
        (t.prototype._verifyIdToken = function (t, e) {
          return (function (t) {
            ...
            var e = (function (t) {
              ...
              var o = JSON.parse(Ec(n)),
                r = { __raw: t },
                l = {};
              return (
                Object.keys(o).forEach(function (t) {
                  (r[t] = o[t]), io.includes(t) || (l[t] = o[t]);
                }),
                {
                  encoded: { header: i, payload: n, signature: c },
                  header: JSON.parse(Ec(i)),
                  claims: r,
                  user: l,
                }
              );
            ...
            if (t.max_age && !eo(e.claims.auth_time))
              throw new Error(
            ...
            var i = t.leeway || 60,
              ...
              r = new Date(0);
            if (
              (r.setUTCSeconds(parseInt(e.claims.auth_time) + t.max_age + i),
              c.setUTCSeconds(e.claims.exp + i),
              o.setUTCSeconds(e.claims.nbf - i),
              n > c)
            )
              throw new Error(
                ...
                switch (d.label) {
                  ...
                  case 1:
                    return (
                      (l = d.sent()),
                      (s = Tc(l)),
                      (u = t.fragment ? '#' + t.fragment : ''),
                      (a = this._getParams(n, c, o, s, e)),
                      (g = this._authorizeUrl(a)),
              ...
              return d(this, function (d) {
                switch (d.label) {
                  ...
                  case 3:
                    return (
                      (b = d.sent()),
                      (y = this._verifyIdToken(b.id_token, c)),
                      (B = a(a({}, b), {
                        decodedToken: y,
                        scope: s.scope,
            ...
            g(this, void 0, void 0, function () {
              ...
              return d(this, function (c) {
                return (
                  ...
                  (i = Dc(this.defaultScope, this.scope, t.scope)),
                  [
                    2,
                    (n = this.cache.get({
                      client_id: this.options.client_id,
            ...
            g(this, void 0, void 0, function () {
              ...
              return d(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return (e = i.sent()), window.location.assign(e), [2];
                }
              });
            })
          );
              ...
              return d(this, function (d) {
                switch (d.label) {
                  ...
                  case 1:
                    return (
                      (u = d.sent()),
                      (I = this._verifyIdToken(u.id_token)),
                      (g = a(a({}, u), {
                        decodedToken: I,
                        audience: l.audience,
                        scope: l.scope,
          ...
          return g(this, void 0, void 0, function () {
            ...
            return d(this, function (i) {
              switch (i.label) {
                ...
                case 1:
                  return (
                    i.trys.push([1, 3, , 4]), [4, this.getTokenSilently(t)]
                  );
                case 2:
                  return i.sent(), [3, 4];
                case 3:
                  if (((e = i.sent()), !Gc.includes(e.error))) throw e;
                  return [3, 4];
                case 4:
                  return [2];
              }
                ...
                switch (u.label) {
                  case 0:
                    if (
                      ...
                      (i = e.ignoreCache),
                      (n = I(e, ['ignoreCache'])),
                      console.log('Getting token silently, ignore cache: ' + i),
                      (c = function () {
                        var t = s.cache.get(
                          {
                            scope: n.scope,
                  ...
                  case 1:
                    return (
                      ...
                      [4, go.acquireLock('auth0.lock.getTokenSilently', 5e3)]
                    );
                  case 2:
                    return (
                      u.sent(),
                ...
                switch (i.label) {
                  case 0:
                    return (
                      ...
                      (t.scope = Dc(this.defaultScope, this.scope, t.scope)),
                      (e = a(a({}, Sc), e)),
        ...
        (t.prototype.buildLogoutUrl = function (t) {
          ...
          var e = t.federated,
            i = I(t, ['federated']),
            n = e ? '&federated' : '';
          return this._url('/v2/logout?' + Nc(i)) + n;
        }),
        (t.prototype.logout = function (t) {
          ...
          if (
            ...
            var n = this.buildLogoutUrl(i);
            window.location.assign(n);
          }
        }),
        (t.prototype._getTokenFromIFrame = function (t) {
          return g(this, void 0, void 0, function () {
            var e, i, n, c, o, r, l, s, u, g, b, y, B, m;
            return d(this, function (d) {
              switch (d.label) {
                case 0:
                  return (e = Yc(wc())), (i = Yc(wc())), (n = wc()), [4, kc(n)];
                case 1:
                  return (
                    (c = d.sent()),
                    (o = Tc(c)),
                    ...
                    (s =
                      t.timeoutInSeconds ||
                      this.options.authorizeTimeoutInSeconds),
                    [4, Hc(l, this.domainUrl, s)]
                  );
                case 2:
                  if (((u = d.sent()), e !== u.state))
                    throw new Error('Invalid state');
                  return (
                    (g = t.scope),
                    (b = t.audience),
                ...
                case 3:
                  return (
                    (B = d.sent()),
                    (m = this._verifyIdToken(B.id_token, i)),
                    [
                      2,
                      a(a({}, B), {
                        decodedToken: m,
    ...
    mo = { isAuthenticated: !1, isLoading: 'undefined' != typeof window },
    ho = function () {
    ...
    Co = e.createContext(po),
    Fo = (function (t) {
      function e(e, i) {
        var n = t.call(this, i || e) || this;
        return (n.error = e), (n.error_description = i), n;
      }
      return (
        (function (t, e) {
          function i() {
    ...
    Zo = function (t) {
      return function (e) {
        return 'error' in e
          ? new Fo(e.error, e.error_description)
          : e instanceof Error
          ? e
          : new Error(t);
      };
    ...
    So = function (t, e) {
      switch (e.type) {
        ...
        case 'GET_TOKEN_COMPLETE':
          return c(c({}, t), { isAuthenticated: !!e.user, user: e.user });
        case 'LOGOUT':
          return c(c({}, t), { isAuthenticated: !1, user: void 0 });
        case 'ERROR':
          return c(c({}, t), { isLoading: !1, error: e.error });
      }
    },
    Go = function (t) {
      window.history.replaceState(
        {},
        document.title,
        (null == t ? void 0 : t.returnTo) || window.location.pathname
      );
    },
    Qo = function () {
  ...
  (t.Auth0Context = Co),
    (t.Auth0Provider = function (t) {
      var n = t.children,
        s = t.skipRedirectCallback,
        u = t.onRedirectCallback,
        a = void 0 === u ? Go : u,
        I = o(t, ['children', 'skipRedirectCallback', 'onRedirectCallback']),
        g = e.useState(function () {
          return new Bo(
            (function (t) {
              var e = t.clientId,
                i = t.clientHash,
                n = t.redirectUri,
                r = t.maxAge,
                l = o(t, ['clientId', 'clientHash', 'redirectUri', 'maxAge']);
              return c(c({}, l), {
                client_id: e,
                clientHash: i,
                redirect_uri: n,
              ...
              switch (n.label) {
                case 0:
                  return (
                    ...
                    !((fo.test(c) && Uo.test(c)) || Vo.test(c)) || s
                      ? [3, 2]
                      : [4, g.handleRedirectCallback()]
                  );
                case 1:
                  return (t = n.sent().appState), a(t), [3, 4];
                case 2:
                  return [
                    4,
                    g.checkSession({ ignoreCache: !1, timeoutInSeconds: 1 }),
                  ];
                case 3:
                  n.sent(), (n.label = 4);
                case 4:
                ...
                case 5:
                  return (
                    (e = n.sent()), y({ type: 'INITIALISED', user: e }), [3, 7]
                  );
                case 6:
                  return (
                    (i = n.sent()), y({ type: 'ERROR', error: Xo(i) }), [3, 7]
                  );
                case 7:
                  return [2];
              }
          ...
          function (t, e) {
            return r(void 0, void 0, void 0, function () {
              ...
              return l(this, function (c) {
                switch (c.label) {
                  case 0:
                    y({ type: 'LOGIN_POPUP_STARTED' }), (c.label = 1);
                  case 1:
                    return (
                      c.trys.push([1, 3, , 4]), [4, g.loginWithPopup(t, e)]
                    );
                  case 2:
                    return c.sent(), [3, 4];
                  case 3:
                    return (
                      (i = c.sent()), y({ type: 'ERROR', error: Xo(i) }), [2]
                    );
                  case 4:
                    return [4, g.getUser()];
                  case 5:
                    return (
                      (n = c.sent()),
                      y({ type: 'LOGIN_POPUP_COMPLETE', user: n }),
                      [2]
                    );
                }
              });
              ...
              return l(this, function (c) {
                switch (c.label) {
                  ...
                  case 4:
                    return (
                      (n = c.sent()),
                      y({ type: 'GET_TOKEN_COMPLETE', user: n }),
                      [2, e]
                    );
                }
              });
            ...
            return r(void 0, void 0, void 0, function () {
              ...
              return l(this, function (o) {
                switch (o.label) {
                  case 0:
                    return (
                      o.trys.push([0, 2, , 3]), [4, g.getTokenWithPopup(t, e)]
                    );
                  case 1:
                    return (i = o.sent()), [3, 3];
                  case 2:
                  ...
                  case 4:
                    return (
                      (c = o.sent()),
                      y({ type: 'GET_TOKEN_COMPLETE', user: c }),
                      [2, i]
                    );
                }
              });
    ...
    (t.OAuthError = Fo),
    (t.useAuth0 = Qo),
    (t.withAuth0 = function (t) {
      return function (e) {
        return i.createElement(Co.Consumer, null, function (n) {
          return i.createElement(t, c({ auth0: n }, e));
        });
      };
    }),
    (t.withAuthenticationRequired = function (t, n) {
      return (
        void 0 === n && (n = {}),
        function (o) {
          var s = this,
