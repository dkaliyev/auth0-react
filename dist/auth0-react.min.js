!(function (t, e) {
  ...
  var dt,
    ...
    Ft = Math.floor,
    Ct = function (t) {
      return isNaN((t = +t)) ? 0 : (t > 0 ? Ft : pt)(t);
    },
    ft = Math.min,
    Ut = function (t) {
  ...
  if (
    (zt ||
      (yt(
        (ri = function () {
          ...
          return F && hi && pi(oi, e, { configurable: !0, set: i }), Fi(e, t);
        }).prototype,
        'toString',
        function () {
          return ci(this).tag;
    ...
    Kt(
      { target: 'Symbol', stat: !0, forced: !zt },
      {
        ...
        keyFor: function (t) {
          if (!Ci(t)) throw TypeError(t + ' is not a symbol');
    ...
    Kt(
      { target: 'Object', stat: !0, forced: !zt, sham: !F },
      {
        create: function (t, e) {
      ...
      { target: 'JSON', stat: !0, forced: Si },
      {
        stringify: function (t, e, i) {
          for (var n, c = [t], o = 1; arguments.length > o; )
            c.push(arguments[o++]);
          if (((n = e), (v(e) || void 0 !== t) && !Ci(t)))
            return (
              ge(e) ||
                (e = function (t, e) {
                  if (
                    ('function' == typeof n && (e = n.call(this, t, e)), !Ci(e))
                  )
                    return e;
                }),
              (c[1] = e),
  ...
  Kt(
    ...
    Bt.Array.from;
  var Fn,
    Cn = 'undefined' != typeof ArrayBuffer && 'undefined' != typeof DataView,
    fn = T.f,
    Un = h.Int8Array,
    Vn = Un && Un.prototype,
  ...
  if (
    ...
    for (Fn in Hn) h[Fn] && qi(h[Fn], xn);
  if ((!Rn || !Sn || Sn === Gn) && ((Sn = xn.prototype), Rn))
    for (Fn in Hn) h[Fn] && qi(h[Fn].prototype, Sn);
  if ((Rn && zi(Xn) !== Sn && qi(Xn, Sn), F && !H(Sn, vn)))
    for (Fn in (fn(Sn, vn, {
      get: function () {
        ...
        hc._immediateFn(function () {
          ...
          if (null !== i) {
            ...
            try {
              ...
              return void Cc(e.promise, t);
            }
            Fc(e.promise, n);
          } else (1 === t._state ? Fc : Cc)(e.promise, t._value);
        }))
      : t._deferreds.push(e);
  }
  function Fc(t, e) {
  ...
  var ao,
    ...
    Zo = function (t) {
      return function (e) {
        return 'error' in e
          ? new Co(e.error, e.error_description)
          : e instanceof Error
          ? e
          : new Error(t);
      };
  ...
  (t.Auth0Context = Fo),
          ...
          function (t) {
            return r(void 0, void 0, void 0, function () {
              ...
              return l(this, function (c) {
                switch (c.label) {
                  case 0:
                    return c.trys.push([0, 2, , 3]), [4, g.getTokenSilently(t)];
                  case 1:
                    return (e = c.sent()), [3, 3];
                  case 2:
                    throw ((i = c.sent()), xo(i));
    ...
    (t.withAuth0 = function (t) {
      return function (e) {
        return i.createElement(Fo.Consumer, null, function (n) {
